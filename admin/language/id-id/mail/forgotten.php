...
$_['text_greeting'] = 'Kami menerima sebuah permintaan untuk mengatur ulang password untuk akun anda di %s .';
$_['text_change']   = 'Klik pada tautan di bawah ini untuk melakukan pengaturan ulang/reset password anda:';
$_['text_ip']       = 'Alamat IP yang digunakan untuk permintaan ini adalah : %s';