 ...
 */
// Text
$_['text_subject']       = '%s - Pembaruan informasi retur produk  %s';
$_['text_return_id']     = 'ID retur:';
$_['text_date_added']    = 'Tanggal permintaan retur:';
$_['text_return_status'] = 'Retur produk anda telah diperbarui dengan status berikut:';
$_['text_comment']       = 'Pesan anda saat melakukan permintaan retur produk adalah:';
$_['text_footer']        = 'Silakan balas ke alamat email ini jika anda memiliki pertanyaan, Terima kasih.';