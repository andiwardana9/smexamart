 ...
 */
// Heading
$_['heading_title']    = 'Status persediaan produk';

// Text
$_['text_success']         = 'Berhasil: Perubahan pengaturan status persediaan produk yang anda lakukan sudah tersimpan dan diperbarui';
$_['text_list']            = 'Daftar status persediaan';
...
// Column
$_['column_name']      = 'Nama status persediaan';
$_['column_action']    = 'Tindakan';

// Entry
$_['entry_name']       = 'Nama status persediaan';

// Error
$_['error_permission'] = 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan status persediaan produk';
$_['error_name']       = 'Mohon maaf: Nama status persediaan produk setidaknya harus terdiri dari 3 sampai 32 karakter';
$_['error_product']    = 'Mohon maaf: Status persediaan ini tidak bisa dihapus karena sedang diterapkan pada %s produk';