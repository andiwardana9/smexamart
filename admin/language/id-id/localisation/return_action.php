 ...
 */
// Heading
$_['heading_title']    = 'Tindakan retur';

// Text
$_['text_success']         = 'Berhasil: Perubahan pengaturan tindakan retur yang anda lakukan sudah tersimpan dan diperbarui';
$_['text_list']            = 'Daftar tindakan retur';
$_['text_add']             = 'Tambah tindakan';
$_['text_edit']            = 'Ubah tindakan';
...
// Column
$_['column_name']      = 'Nama tindakan retur';
$_['column_action']    = 'Tindakan';

// Entry
$_['entry_name']       = 'Nama tindakan retur';

// Error
$_['error_permission'] = 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan tindakan retur';
$_['error_name']       = 'Mohon maaf: Nama tindakan retur setidaknya harus terdiri dari 3 sampai 64 karakter';
$_['error_return']     = 'Mohon maaf: Tindakan retur ini tidak bisa dihapus karena sedang diterapkan pada %s pengembalian produk/retur';