 ...
 */
// Heading
$_['heading_title']                           = 'Anti-Penipuan MaxMind';

// Text
$_['text_extension']                          = 'Anti-Penipuan';
$_['text_success']                            = 'Berhasil: Perubahan pengaturan Anti-Penipuan MaxMind yang anda lakukan sudah tersimpan dan diperbarui';
$_['text_edit']                               = 'Ubah pengaturan';
$_['text_signup']                             = 'MaxMind adalah layanan pendeteksi anti penipuan. Jika anda tidak memiliki license key silahkan <a href="http://www.maxmind.com/?rId=opencart" target="_blank"><u>Mendaftar disini terlebih dahulu</u></a>.';
...
// Entry
$_['entry_key']                               = 'License Key MaxMind';
$_['entry_score']                             = 'Skor resiko';
$_['entry_order_status']                      = 'Status pesanan';
$_['entry_status']                            = 'Status';

// Help
$_['help_order_status']                       = 'Untuk pesanan yang memiliki skor melebihi dari skor resiko yang anda tentukan akan otomatis diberikan status pesanan ini dan tidak akan mencapai status complete/selesai/komplit.';
