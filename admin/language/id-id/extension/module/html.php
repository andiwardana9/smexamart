...
$_['text_success']      = 'Berhasil: Perubahan pengaturan modul konten HTML yang anda lakukan sudah tersimpan dan diperbarui';
$_['text_edit']         = 'Ubah pengaturan';

// Entry
$_['entry_name']        = 'Nama Modul';
$_['entry_title']       = 'Judul heading';
$_['entry_description'] = 'Isi konten';
$_['entry_status']      = 'Status';

// Error
$_['error_permission']  = 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan modul konten HTML';
$_['error_name']        = 'Mohon maaf: Nama modul setidaknya harus terdiri 3 dan 64 karakter';