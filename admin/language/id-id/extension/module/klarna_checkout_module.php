 ...
 */
// Heading
$_['heading_title']	   = 'Checkout menggunakan Klarna';

// Text
$_['text_extension']   = 'Modul';
$_['text_success']     = 'Berhasil: Perubahan pengaturan modul checkout menggunakan Klarna yang anda lakukan sudah tersimpan dan diperbarui';

//Entry
$_['entry_status']	   = 'Status';

//Error
$_['error_permission'] = 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan modul checkout menggunakan Klarna';