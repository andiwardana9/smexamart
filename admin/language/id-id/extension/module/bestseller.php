...
$_['text_success']     = 'Berhasil: Perubahan pengaturan modul produk terlaris yang anda lakukan sudah tersimpan dan diperbarui';
$_['text_edit']        = 'Ubah pengaturan';

// Entry
$_['entry_name']       = 'Nama modul';
$_['entry_limit']      = 'Jumlah max produk yg ditampilkan';
$_['entry_image']      = 'Gambar (L x T) dan tipe resize';
$_['entry_width']      = 'Ukuran Lebar gambar produk';
$_['entry_height']     = 'Ukuran Tinggi gambar produk';
$_['entry_status']     = 'Status';

// Error
$_['error_permission'] = 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan modul produk terlaris';
