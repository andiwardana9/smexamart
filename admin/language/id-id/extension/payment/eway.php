...
$_['text_success']			    = 'Berhasil: Perubahan pengaturan metode pembayaran eWAY yang anda lakukan sudah tersimpan dan diperbarui';
...
$_['text_sale']					= 'Sale';
$_['text_transparent']			= 'Transparent Redirect (Form pembayaran pada toko online anda)';
$_['text_iframe']				= 'IFrame (Form pembayaran pada window baru)';

// Entry
$_['entry_paymode']				= 'Mode pembayaran';
$_['entry_test']				= 'Mode percobaan';
$_['entry_order_status']		= 'Status pesanan';
$_['entry_order_status_refund'] = 'Status pesanan refund';
$_['entry_order_status_auth']	= 'Status pesanan Authorisation';
$_['entry_order_status_fraud']	= 'Status pesanan terduga penipuan';
$_['entry_status']				= 'Status';
$_['entry_username']			= 'API Key eWAY ';
$_['entry_password']			= 'Password eWAY ';
$_['entry_payment_type']		= 'Tipe pembayaran';
$_['entry_geo_zone']			= 'Kelompok wilayah';
$_['entry_sort_order']			= 'No urut';
$_['entry_transaction_method']	= 'Metode transaksi';

// Error
$_['error_permission']			= 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan metode pembayaran eWAY';
$_['error_username']			= 'Mohon maaf: Anda belum memasukan API Key eWAY anda, atau API Key eWAY yang anda masukan salah, mohon diperiksa kembali.';
$_['error_password']			= 'Mohon maaf: Anda belum memasukan Password eWAY anda, atau Password eWAY yang anda masukan salah, mohon diperiksa kembali.';
$_['error_payment_type']		= 'Mohon maaf: Setidaknya anda harus memilih salah satu Tipe pembayaran';

// Help hints
$_['help_testmode']				= 'Pilih YA jika anda menginginkan untuk melakukan simulasi pembayaran dengan menggunakan metode ini dengan tujuan menguji/test koneksi antara sistem toko online anda dengan API metode pembayaran terkait (Pembayaran yang dilakukan pada mode percobaan ini tidak akan masuk pada akun anda). Dan pilih TIDAK jika anda ingin langsung mengaktifkan untuk melakukan pembayaran yang sesungguhnya menggunakan metode pembayaran ini.';
$_['help_username']				= 'API key dari akun MYeWAY anda.';
$_['help_password']				= 'Password yang anda gunakan untuk mengakses akun MYeWAY anda.';
$_['help_transaction_method']	= 'Authorisation hanya tersedia untuk bank-bank yang tersedia di Australia';
