...
$_['text_success']					= 'Berhasil: Perubahan pengaturan metode pembayaran Bank transfer yang anda lakukan sudah tersimpan dan diperbarui';
$_['text_edit']                     = 'Ubah pengaturan';

// Entry
$_['entry_bank']					= 'Instruksi & Informasi bank';
...
// Error
$_['error_permission']				= 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan metode pembayaran bank transfer';
$_['error_bank']					= 'Mohon maaf: Anda belum memasukan instruksi & informasi bank anda, atau instruksi& informasi bank yang anda masukan salah, mohon diperiksa kembali.';