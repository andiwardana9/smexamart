...
$_['text_success']			 = 'Berhasil: Perubahan pengaturan metode pembayaran BluePay Hosted Form yang anda lakukan sudah tersimpan dan diperbarui';
...
$_['help_transaction']		 = 'Sale akan secara otomatis menarik secara langsung pembayaran. Authorization: pihak bluepay akan menahan pembayaran dari pelanggan, jika anda ingin menerima pembayaran tersebut harus anda terima secara manual pada pengaturan akun bluepay anda.';
...
// Error
$_['error_permission']		 = 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan metode pembayaran BluePay Hosted Form';
$_['error_account_name']	 = 'Mohon maaf: Anda belum memasukan nama akun anda, atau nama akun yang anda masukan salah, mohon diperiksa kembali';
