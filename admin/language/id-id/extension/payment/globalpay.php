...
$_['text_success']			         = 'Berhasil: Perubahan pengaturan metode pembayaran Globalpay Redirect yang anda lakukan sudah tersimpan dan diperbarui';
$_['text_edit']                      = 'Ubah pengaturan';
$_['text_live']						 = 'Live (Aktif)';
$_['text_demo']						 = 'Demo';
$_['text_card_type']				 = 'Tipe kartu';
$_['text_enabled']					 = 'Aktifkan';
$_['text_use_default']				 = 'Gunakan sebagai default/utama';
$_['text_merchant_id']				 = 'ID merchant';
$_['text_subaccount']				 = 'Sub Akun';
...
$_['text_url_message']				 = 'Anda harus memberikan/memasukan Server alamat IP anda sebelumnya pada Akun manager Globalpay anda sebelum bisa mengaktifkan (live) metode pembayaran ini.';
...
$_['entry_status_decline_pending']	 = 'Ditolak - Auth yang offline';
$_['entry_status_decline_stolen']	 = 'Ditolak - Kartu yang hilang/dicuri';
$_['entry_status_decline_bank']		 = 'Ditolak - kesalahan pada bank';
$_['entry_status_void']				 = 'Dibatalkan';
$_['entry_status_rebate']			 = 'Direbate';
$_['entry_notification_url']		 = 'URL notifikasi';
...
$_['help_notification']				 = 'Anda harus memberikan/menyalin URL ini pada pengaturan akun Globalpay anda untuk mendapatkan notifikasi pembayaran.';
...
$_['help_dcc_settle']				 = 'Jika sub akun anda mengaktifkan DCC maka anda diwajibkan memilih Autosettle.';
...
// Error
$_['error_permission']		         = 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan metode pembayaran Globalpay Redirect';
$_['error_merchant_id']				 = 'Mohon maaf: Anda belum memasukan Merchant ID anda, atau Merchant ID yang anda masukan salah, mohon diperiksa kembali';
$_['error_secret']					 = 'Mohon maaf: Anda belum memasukan Shared secret anda, atau shared secret yang anda masukan salah, mohon diperiksa kembali.';
$_['error_live_url']				 = 'Mohon maaf: Anda belum memasukan URL live (Aktif) anda, atau URL live (Aktif) yang anda masukan salah, mohon diperiksa kembali.';
$_['error_demo_url']				 = 'Mohon maaf: Anda belum memasukan URL demo anda, atau URL demo yang anda masukan salah, mohon diperiksa kembali.';
$_['error_data_missing']			 = 'Data missing';
$_['error_use_select_card']			 = 'Mohon maaf: Anda harus mengaktifkan "Pilih kartu" jika ingin memungkinkan untuk sub akun routing dengan tipe kartu untuk bekerja.';