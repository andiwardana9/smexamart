...
$_['text_success']			         = 'Berhasil: Perubahan pengaturan metode pembayaran Globalpay Remote yang anda lakukan sudah tersimpan dan diperbarui';
...
$_['text_ip_message']				 = 'Anda harus memberikan/memasukan Server alamat IP anda sebelumnya pada Akun manager Globalpay anda sebelum bisa mengaktifkan (live) metode pembayaran ini.';
...
$_['entry_card_data_status']		 = 'Logging info kartu';
$_['entry_3d']						 = 'Aktifkan 3D secure';
$_['entry_liability_shift']			 = 'Menerima skenario pembayaran Non-liability';
...
$_['help_notification']				 = 'Anda harus memberikan URL ini pada pengaturan akun Globalpay anda untuk mendapatkan notifikasi pembayaran.';
...
$_['help_liability']				 = 'Jika anda memilih YA maka anda akan tetap bisa menerima pembayaran meskipun pengguna/pelanggan gagal pada 3D secure..';
$_['help_card_data_status']			 = 'Pelanggan akan diminta memasukan hanya 4 angka terakhir kartu kredit,tanggal expire, Nama pemegang kartu, tipe kartu yang digunakan, serta informasi bank yang digunakan.';
...
// Error
$_['error_permission']		         = 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan metode pembayaran Globalpay Remote';
