...
$_['text_success']		 = 'Berhasil: Perubahan pengaturan metode pembayaran Pembayaran Ditempat (COD) yang anda lakukan sudah tersimpan dan diperbarui';
...
// Error
$_['error_permission']	 = 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan metode pembayaran Pembayaran Ditempat (COD).';