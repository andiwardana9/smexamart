 ...
 */
// Heading
$_['heading_title']			= 'Klarna akun';

// Text
$_['text_extension']	    = 'Metode pembayaran';
$_['text_success']			= 'Berhasil: Perubahan pengaturan metode pembayaran Klarna akun yang anda lakukan sudah tersimpan dan diperbarui';
...
$_['entry_server']			= 'Mode percobaan';
$_['entry_total']			= 'Total belanja min';
$_['entry_pending_status']	= 'Status pesanan ditunda';
$_['entry_accepted_status'] = 'Status pesanan diterima';
$_['entry_geo_zone']		= 'Kelompok wilayah';
$_['entry_status']			= 'Status';
$_['entry_sort_order']		= 'No urut';

// Help
$_['help_merchant']			= '(estore id) Untuk digunakan pada layanan klarna (ID ini diberikan oleh Klarna).';
$_['help_secret']			= 'Shared secret yang digunakan bersama layanan klarna (Shared secret ini diberikan oleh Klarna).';
$_['help_server']			= 'Pilih BETA jika anda menginginkan untuk melakukan simulasi pembayaran dengan menggunakan metode ini dengan tujuan menguji/test koneksi antara sistem toko online anda dengan API metode pembayaran terkait (Pembayaran yang dilakukan pada mode percobaan ini tidak akan masuk pada akun anda). Dan pilih LIVE jika anda ingin langsung mengaktifkan untuk melakukan pembayaran yang sesungguhnya menggunakan metode pembayaran ini.';
...
// Error
$_['error_permission']		= 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan metode pembayaran Klarna akun';
