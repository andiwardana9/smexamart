 ...
 */
// Heading
$_['heading_title']    = 'Fitur biaya Low Order';

// Text
$_['text_extension']   = 'Fitur keranjang belanja';
$_['text_success']     = 'Berhasil: Perubahan pengaturan Fitur biaya Low Order yang anda lakukan sudah tersimpan dan diperbarui';
$_['text_edit']        = 'Ubah pengaturan';

// Entry
$_['entry_total']      = 'Total belanja min';
$_['entry_fee']        = 'Biaya yang dikenakan';
$_['entry_tax_class']  = 'Kelas Pajak';
$_['entry_status']     = 'Status';
$_['entry_sort_order'] = 'No urut';

// Help
$_['help_total']       = 'Masukan nilai total belanja yang termasuk low order (dibawah jumlah minimum pembelian), pelanggan yang melakukan pesanan dengan total belanja dibawah atau setara dengan nilai/jumlah ini makan akan secara otomatis akan dikenakan biaya low order, Jika pelanggan melakukan pesanan dengan total belanja diatas nilai ini maka tidak akan dikenakan biaya low order';

// Error
$_['error_permission'] = 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan Fitur biaya Low Order';
