 ...
 */
// Heading
$_['heading_title']    = 'Fitur biaya handling fee';

// Text
$_['text_extension']   = 'Fitur keranjang belanja';
$_['text_success']     = 'Berhasil: Perubahan pengaturan Fitur biaya handling fee yang anda lakukan sudah tersimpan dan diperbarui';
$_['text_edit']        = 'Ubah pengaturan';

// Entry
$_['entry_total']      = 'Total belanja min';
$_['entry_fee']        = 'Biaya handling (tambahan)';
$_['entry_tax_class']  = 'Kelas Pajak';
$_['entry_status']     = 'Status';
$_['entry_sort_order'] = 'No urut';

// Help
$_['help_total']       = 'Total belanja minimum yang harus dicapai oleh pelanggan agar fitur biaya handling fee ini tersedia dan ditampilkan pada pelanggan';

// Error
$_['error_permission'] = 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan Fitur biaya handling fee';