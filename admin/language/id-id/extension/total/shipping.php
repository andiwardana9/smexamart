 ...
 */
// Heading
$_['heading_title']    = 'Fitur perkiraan tarif pengiriman & PPN';

// Text
$_['text_extension']   = 'Fitur keranjang belanja';
$_['text_success']     = 'Berhasil: Perubahan pengaturan Fitur perkiraan biaya pengiriman & PPN yang anda lakukan sudah tersimpan dan diperbarui';
$_['text_edit']        = 'Ubah pengaturan';

// Entry
$_['entry_estimator']  = 'Perkiraan tarif ongkos kirim';
$_['entry_status']     = 'Status';
$_['entry_sort_order'] = 'No urut';

// Error
$_['error_permission'] = 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan Fitur perkiraan tarif pengiriman & PPN';