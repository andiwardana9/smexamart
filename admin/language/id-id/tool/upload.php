 ...
 */
// Heading
$_['heading_title']     = 'Daftar file yang di upload';

// Text
$_['text_success']      = 'Berhasil: Perubahan pengaturan pada daftar file upload yang anda lakukan sudah tersimpan dan diperbarui';
$_['text_list']         = 'Daftar file';
...
// Column
$_['column_name']       = 'Nama upload';
$_['column_filename']   = 'Nama file';
$_['column_date_added'] = 'Tanggal ditambahkan';
$_['column_action']     = 'Tindakan';

// Entry
$_['entry_name']        = 'Nama upload';
$_['entry_filename']    = 'Nama file';
$_['entry_date_added'] 	= 'Tanggal ditambahkan';

// Error
$_['error_permission']  = 'Mohon maaf: Anda tidak memiliki izin untuk menyimpan perubahan pengaturan pada bagian ini';