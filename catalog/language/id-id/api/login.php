 ...
 */
// Text
$_['text_success'] = 'Berhasil: Sesi API telah dimulai';

// Error
$_['error_login']  = 'Mohon maaf: Username atau password yang anda masukan salah, mohon diperiksa kembali';
$_['error_ip']   = 'Mohon maaf: Alamat IP yang anda gunakan tidak dizinkan untuk mengakses API ini';