...
// Text
$_['text_message'] = '<p> Selamat! Akun pelanggan anda telah berhasil dibuat </p> <p> Sekarang anda bisa mendapatkan keuntungan-keuntungan sebagai anggota dan memperoleh pengalaman berbelanja online bersama kami. </p> <p> Jika Anda memiliki pertanyaan apapun mengenai toko online ini, Silahkan kirimkan e-mail kepada kami. </p> <p>konfirmasi akun telah dikirimkan pada alamat e-mail yang anda gunakan pada pendaftaran. Jika Anda tidak menerimanya dalam jangka waktu satu jam, mohon untuk <a href="%s">menghubungi kami</a></p> ';
$_['text_approval'] = '<p> Terima kasih banyak untuk pendaftaran akun anda pada %s</p> <p> Kami akan segera memberitahu anda melalui e-mail begitu akun anda telah diaktifkan. </p> <p> Jika Anda tidak menerimanya dalam jangka waktu satu jam, mohon untuk <a href="%s">menghubungi kami</a> </p>.';
$_['text_account']  = 'Akun';
