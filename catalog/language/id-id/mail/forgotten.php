...
$_['text_greeting'] = 'Kami menerima sebuah sebuah permintaan untuk pengaturan ulang / reset password untuk akun anda di %s.';
$_['text_change']   = 'Untuk melakukan pengaturan ulang password anda, mohon klik link dibawah ini:';
$_['text_ip']       = 'Alamat IP yang meminta pengaturan ulang password ini adalah: %s';
