 ...
 */
// Text
$_['text_title']			 = 'Kartu Credit / Debit (Worldpay)';
$_['text_credit_card']		 = 'Detail kartu';
$_['text_card_type']		 = 'Tipe kartu: ';
$_['text_card_name']		 = 'Nama pemiliki kartu: ';
$_['text_card_digits']		 = 'Digit terakhir: ';
$_['text_card_expiry']		 = 'Tanggal kadaluarsa: ';
$_['text_trial']			 = '%s setiap %s %s untuk %s Pembayaran selanjutnya ';
$_['text_recurring']		 = '%s setiap %s %s';
$_['text_length']			 = ' untuk pembayaran %sx';
$_['text_confirm_delete']	 = 'Apakah anda yakin ingin menghapus kartu ini?';
$_['text_card_success']		 = 'Kartu telah berhasil dihapus';
$_['text_card_error']		 = 'Telah terjadi kesalahan ketika sistem mencoba untuk menyingkirkan / menghapus kartu anda, mohon hubungi kami admin kami untuk mengatasi masalah ini';

// Entry
$_['entry_card']			 = 'Kartu baru atau yang sudah ada: ';
$_['entry_card_existing']	 = 'Yang sudah ada';
$_['entry_card_new']		 = 'Baru';
$_['entry_card_save']		 = 'SImpan detail kartu';
$_['entry_cc_cvc']			 = 'Card Verification Code (CVC)';
$_['entry_cc_choice']		 = 'Pilih kartu yang sudah tersimpan';

// Button
$_['button_delete_card']	 = 'Hapus kartu';

// Error
$_['error_process_order']	 = 'Mohon maaf: Telah terjadi eror ketika kami mencoba untuk memproses pesanan anda, Mohon hubungi admin toko untuk mendapatkan bantuan';
